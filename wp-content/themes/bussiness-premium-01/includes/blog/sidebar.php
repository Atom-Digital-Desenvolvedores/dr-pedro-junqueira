	...
	Class WQ_Widget_Search extends WP_Widget_Search {
		function widget( $args, $instance ) {
			...
			?>
				...
				<!-- <?php if ($title !== NULL && strlen($title) > 0) { ?>
						<h3><?php echo $title; ?></h3>
				<?php } ?> -->
				<form method="get" action="<?php echo home_url(); ?>" class="wq-buscar">
					...
					<li>
						<figure>
							<a href="<?php the_permalink(); ?>">
								<?php getImageThumb($attachID, '370x250'); ?>
							</a>
						</figure>
						<p><?php echo get_the_date('d', $item->ID); ?> de <?php echo get_the_date('F', $item->ID); ?> de <?php echo get_the_date('Y', $item->ID); ?></p>
	...
	Class WQ_Categories_Widget extends WP_Widget_Categories {
		function widget( $args, $instance ) {
			...
			?>
				...
				<div class="wq-sidebar_box wq-categorias">
					<?php
						if ( $title ) {
							?>
								<h3><?php echo $title; ?></h3>
